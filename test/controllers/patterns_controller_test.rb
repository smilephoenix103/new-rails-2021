...
class PatternsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post patterns_url, params: { pattern: { description: @pattern.description, name_en: @pattern.name_en, name_pl: @pattern.name_pl } }
    end
  ...
  test "should update pattern" do
    patch pattern_url(@pattern), params: { pattern: { description: @pattern.description, name_en: @pattern.name_en, name_pl: @pattern.name_pl } }
