...
class SignaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post signatures_url, params: { signature: { description: @signature.description, short_name: @signature.short_name, signature_cod: @signature.signature_cod } }
    end
  ...
  test "should update signature" do
    patch signature_url(@signature), params: { signature: { description: @signature.description, short_name: @signature.short_name, signature_cod: @signature.signature_cod } }
